GESTwrapper.static2 <- function(configuration, locations, binSize) {
  ...
  subset0 <- c(13,16,39,42)
  subset1 <- c(1,3,12,14,18,29,31,33,35,45,47,49)
  subset2 <- c(2,4,11,15,17,28,30,32,34,36,46,48,50)
  subset3 <- c(5,7,9,20,22,24,26,38,40,44,51,53)
  subset4 <- c(6,8,10,19,21,23,25,27,37,41,43,52,54)
  subsets <- list(subset0,subset1,subset2,subset3,subset4)
