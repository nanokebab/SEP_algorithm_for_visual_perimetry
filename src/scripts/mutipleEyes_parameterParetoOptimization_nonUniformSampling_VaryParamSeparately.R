mutipleEyes_parameterParetoOptimization_nonUniformSampling_VaryParamSeparately <- function() {
  ...
  for (e in 1:nSamples) {
    ...
    #   strt<-Sys.time()
    #   Finals[[e]] <- lapply(configurations.list, GESTwrapper.indepLocs, locations=locations, binSize = binSize)
    #   print(Sys.time()-strt)
  ...
  # save all
  save.image("data/final/mutipleEyes_parameterParetoOptimization_nonUniformSampling_VaryParamSeparately.RData")
